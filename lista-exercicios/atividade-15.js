...
function completarTexto() {
    ...
    texto.innerText = "Meu nome é Manu Renzi, tenho 17 anos, moro em Mogi, estudo no Ensino Médio e faço o curso de Desenvolvimento de Sistemas.";
}
